...
class system:
    def __init__(self,keyParams,boolParams, numParams, samples, samplesCount, nodesCount,attrsCount, majorant = False, logWriter = None):
        '''the LICS itself'''
    ...
    def initialise(self):
        ...
        for i in range(int(self.maxNodesCount*rateTrees)):
            newCh = chromo(self,
    ...
    def removeTree(self,tree):
        ...
        self.currentAttrsCount -= len(tree.boolStatements)+ len(tree.numStatements)
    ...
    def classify(self,sample,threshold = 0):  
